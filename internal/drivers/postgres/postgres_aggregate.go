...
// needs a recreation.
func (a *PostgresAggregate) Diff(other *PostgresAggregate) []driversshared.Instruction {
	if a.Equal(other) {
		return nil
	}

	return []driversshared.Instruction{other.DropInstruction(), a.CreateInstruction()}
}
