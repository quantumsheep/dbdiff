...
func (t *PostgresCompositeType) Diff(other *PostgresCompositeType) []driversshared.Instruction {
	if t.Equal(other) {
		return nil
	}

	return []driversshared.Instruction{other.DropInstruction(), t.CreateInstruction()}
}
