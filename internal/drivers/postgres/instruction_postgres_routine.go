...
func (i *PostgresCreateFunctionInstruction) Comment() string {
	return driversshared.DefinitionComment("Create", "function", i.Definition, "FUNCTION")
}
...
func (i *PostgresDropFunctionInstruction) String() string {
	return fmt.Sprintf("DROP FUNCTION %s(%s);", driversshared.QuoteIdentifier(i.Name), i.Arguments)
}

func (i *PostgresDropFunctionInstruction) Comment() string {
	return driversshared.ObjectComment("Drop", "function", i.Name)
}
...
func (i *PostgresCreateProcedureInstruction) Comment() string {
	return driversshared.DefinitionComment("Create", "procedure", i.Definition, "PROCEDURE")
}
...
func (i *PostgresDropProcedureInstruction) String() string {
	return fmt.Sprintf("DROP PROCEDURE %s(%s);", driversshared.QuoteIdentifier(i.Name), i.Arguments)
}

func (i *PostgresDropProcedureInstruction) Comment() string {
	return driversshared.ObjectComment("Drop", "procedure", i.Name)
}
...
func (i *PostgresCreateAggregateInstruction) String() string {
	...
	if i.InitialCondition.Valid {
		options = append(options,
			fmt.Sprintf("INITCOND = %s", driversshared.QuoteLiteral(i.InitialCondition.String)))
	}
	...
	if i.MovingInitialCondition.Valid {
		options = append(options,
			fmt.Sprintf("MINITCOND = %s", driversshared.QuoteLiteral(i.MovingInitialCondition.String)))
	}
	...
	return fmt.Sprintf("CREATE AGGREGATE %s(%s) (%s);",
		driversshared.QuoteIdentifier(i.Name), i.Arguments, strings.Join(options, ", "))
}

func (i *PostgresCreateAggregateInstruction) Comment() string {
	return driversshared.ObjectComment("Create", "aggregate", i.Name)
}
...
func (i *PostgresDropAggregateInstruction) String() string {
	return fmt.Sprintf("DROP AGGREGATE %s(%s);", driversshared.QuoteIdentifier(i.Name), i.Arguments)
}

func (i *PostgresDropAggregateInstruction) Comment() string {
	return driversshared.ObjectComment("Drop", "aggregate", i.Name)
}
...
func (i *PostgresCreateOperatorInstruction) String() string {
	options := []string{fmt.Sprintf("FUNCTION = %s", driversshared.QuoteIdentifier(i.Function))}
...
func (i *PostgresCommentOnRoutineInstruction) String() string {
	return fmt.Sprintf("COMMENT ON ROUTINE %s(%s) IS %s;",
		driversshared.QuoteIdentifier(i.Name), i.Arguments, commentLiteral(i.Text))
}

func (i *PostgresCommentOnRoutineInstruction) Comment() string {
	return driversshared.ObjectComment("Modify", "function", i.Name)
}
